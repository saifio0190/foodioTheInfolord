...
<head>
    ...
    <script src="public/js/admin_order.js"></script>
                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            <img src="public/images/icon/logo.png" alt="foodiO" />
                        </a>
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                      ...
                      <!--   <li>
                            <a href="{{url('/orders')}}">
                                <i class="fas fa-table"></i>Oredrs</a>
                        </li> -->
                         <li class="has-sub">
                        ...
                        <li>
                            <a href="{{url('/items')}}">
                                <i class="far fa-check-square"></i>Manage Item</a>
                        </li>
                      <!--   <li>
                            <a href="#">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-copy"></i>Tables & category</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="{{url('/catNtable')}}">Tables/Cusines categry</a>
                                </li>
                                <li>
                                    <a href="{{url('/addcatNtable')}}">Add Tables/Cusines categry</a>
                                </li>
                    ...
                    <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li>
                                    <a href="{{url('/admindashboard')}}">Dashboard 2</a>
                                </li>
                             <!--    <li>
                       ...
                       <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-copy"></i>Cusine</a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="{{url('/items')}}">Cusines</a>
                                </li>
                                <li>
                                    <a href="{{url('/addItem')}}">Add Cusines</a> 
                                </li>
        ...
        <div class="page-container">
                                   ...
                                   <!--  <div class="noti__item js-item-menu">
                                    ...
                                    <div class="noti__item js-item-menu">
                                      <i class="zmdi zmdi-shopping-cart"></i>
                                        <span class="quantity" id="pendingOrders">3</span>
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            ...
                                            <a class="js-acc-btn" href="#">{{ Session::get('adminusers') }}</a>
                                        </div>
            ...
            <!-- END PAGE CONTAINER-->
                   ...
                   <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                  <p>Copyright © 2019 foodO. All rights reserved. </p>
                                </div>
                            </div>
                        </div>
