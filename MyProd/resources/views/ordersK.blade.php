                            ...
                            <form action="#" method="post">
                              {{csrf_field()}}
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="email" name="email"  id="userEmail" value="{{ Session::get('chefusers') }}" >
                                    ...
                                    <table class="table table-borderless table-data3">
                                        ...
                                        <tbody>
                                               ...
                                               <!--         <td class="text-center">{{substr($order->created_at ,5,5) }}</td>
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <button class="item" 
                                                        onclick="makeOrderPayk('{{$order->id}}','{{$order->order_id}}')" 
                                            ...
                                            <?php  
                                              ...
                                              <tr id="hiddenTr2Expandit{{$key}}" class="<?php echo $orderClassName;?>" style="display:none; ;">
                                              <td class="text-center">{{$order->order_id}}</td>
                                              <td class="text-center">{{$order->qty}}</td>
                                              <td class="text-center">{{$order->tableId}}</td>
                                              <td class="text-center">{{$order->deliverBy}}</td>
