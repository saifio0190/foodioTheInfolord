...
$response = ['status' => 0, 'msg' => 'failed','userType' =>'admin'];
            ...
            if ($user && Hash::check($password, $user->password)){
              ...
              session(['adminusers' => $user->name]);
              Session::save();
              setcookie('adminusers', $email, time()+60*60*24*365);
              // dd((session()->all());
              // dd(Session::all());
              $response = ['status' => 1, 'msg' => 'success','userType' =>'admin'];
            ...
            if ($user && Hash::check($password, $user->password)){
              ...
              Session::save();
              $response = ['status' => 1, 'msg' => 'success','userType' =>'chef'];
            }else{
              $response = ['status' => 0, 'msg' => 'failed','userType' =>'chef'];
            }

        }else{
         
          $response = ['status' => 0, 'msg' => 'failed','userType' =>'unknown'];
        }
