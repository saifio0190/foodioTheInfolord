...
<section class="backgraound">
  <div class="container" >
    ...
    <select class="" name="searchCategory" id="searchCategory">
  ...
  <div class="modal fade" id="myModal" data-backdrop="static" data-keyboard="false" role="dialog" style="overflow-y: auto;">
    ...
    <option value="1">Online Razorpay</option>
...
<section class="saction5" style="background-color:aliceblue;">
...
@foreach($homeitems as $key => $item)
@php
if($item->isSpecial == 0 && $item->category =="mainCouse"){
@endphp
    <div class="col-lg-4 col-md-4 col-sm-4">
      <div class="slider clearfix os-animation" data-os-animation="fadeInDown
        " data-os-animation-delay="1s">
...
@foreach($homeitems as $key => $item)
@php
if($item->isSpecial == 0 && $item->category =="salad" ){
